...
- **[Sign in with Enjab](/docs/sign-in-with-enjab)** handles _who the user is_ and
...
[Sign in with Enjab → register](/docs/sign-in-with-enjab) for the exact steps.
</Step>
...
integration — copy them from [Sign in with Enjab](/docs/sign-in-with-enjab).
</Step>
