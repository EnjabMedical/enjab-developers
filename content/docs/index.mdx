...
Everything an Enjab tool needs is here: how to add **Sign in with Enjab**, how to ship
...
<Cards>
  <Card title="Sign in with Enjab" href="/docs/sign-in-with-enjab" description="Use Enjab as your identity provider. Login, two-factor, sessions, roles, and access control — all handled centrally." />
